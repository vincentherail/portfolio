    ...
    main.l-main
      ...
      section.about.section#about
        ...
        .about__container.bd-grid
          ...
          div
            ...
            br/ Aujourd’hui je souhaite intégrer une structure dynamique et reconnue pour donner le meilleur de moi-même   Grand exode is coming      
      ...
      section.contact.section#contact
          ...
          .contact__container.bd-grid
              form.contact__form(action="")
                  input.contact__input(type="text" placeholder="Name")
